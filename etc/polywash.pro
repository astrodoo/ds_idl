pro polywash, x, y, alpha=alpha, color=color, edges=edges, thick=thick, linestyle=linestyle
;;==========================================================================
;;
...
if keyword_set(edges) then begin
    ...
    plots, [x, x[0]], [y, y[0]], /device, color=color, thick=thick, linestyle=linestyle
endif
